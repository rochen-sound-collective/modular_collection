...
mod tests {
    ...
    fn test_process_chord_event() {
        ...
        processor.process_chord_event::<Patterns>(NoteOn {
            note:60,
            velocity: 1.0,
            voice_id: None,
            timing: 0,
        ...
        processor.process_chord_event::<Patterns>(NoteOff {
            note:60,
            velocity: 1.0,
            voice_id: None,
            timing: 0,
    ...
    fn test_process_pattern_event() {
        ...
        let pattern_vec: Vec<PluginNoteEvent<P>> = processor.released_pattern_keys.clone().into_iter().collect();
        assert_eq!(pattern_vec,
           [NoteOff {
            note:60,
            velocity: 1.0,
    ...
    fn test_end_cycle() {
        ...
        // press pattern note
        //---------------------------------->
        processor.process_pattern_event::<Patterns>(NoteOn {
            note:60,
            velocity: 1.0,
            voice_id: None,
            timing: 0,
